...
- [x] Implement admin, user and dealership authentication using JWT(Json Web Token ).
...
- [ ] Create REST endpoints for user :
  ...
  - [x] To view all cars
  - [x] To view all cars in a dealership
  - [x] To view dealerships with a certain car
  - [x] To view all vehicles owned by user
  - [ ] To view the dealerships within a certain range based on user location(use maps api)
  - [x] To view all deals on a certain car
  - [x] To view all deals from a certain dealership
...
- [x] Use ES6 compatible code i.e. use ES modules for import rather than common js import, use promises instead of callbacks etc.

- [x] Use faker js to create dummy data.

- [ ] Provide basic api documentation for your code.

- [x] You are not allowed to use the Mongoose library for this assignment.
